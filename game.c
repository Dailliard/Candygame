...
//Fonctions pour charger et sauvegarder le niveau 1
...
//Fonctions pour charger et sauvegarder le niveau 2
...
//Fonctions pour charger et sauvegarder le niveau 3
...
void sauvegarder(Donnees *data){
    ...
    // Supprimer l'ancien fichier de sauvegarde et renommer le fichier temporaire
